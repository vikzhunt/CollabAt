...
import { getAllUsers, sendConnectionRequest, acceptConnectionRequest, getPendingRequests } from "./../../APIs/User.js";  
...
const UserList = () => {
  ...
  useEffect(() => {
    ...
    if (search === "") {
      const filtered = users.filter(
        (user) => !user.connections?.includes(cr)
      );
  ...
  }, [search, users, connections, filteredUsers]);
