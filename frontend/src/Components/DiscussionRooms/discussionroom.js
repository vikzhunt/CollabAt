...
const DiscussionRooms = () => {
  const [rooms] = useState([
    { name: 'AI & Machine Learning', image: 'https://media.istockphoto.com/id/1824739537/photo/ai-chatbot-block-blue-concepts.webp?a=1&b=1&s=612x612&w=0&k=20&c=CAgPYii0_qP8yEWre63J4lguZzVxsdTS4W1LnTE5hvM=' },
    { name: 'Web Development', image: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTR8fHdlYiUyMGR8ZW58MHx8MHx8fDA%3D' },
    { name: 'Data Science', image: 'https://images.unsplash.com/photo-1666875753105-c63a6f3bdc86?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8ZGF0YSUyMHNjaWVuY2V8ZW58MHx8MHx8fDA%3D' }
  ]);
  ...
  return (
    <div className="p-8 bg-slate-100 rounded-lg shadow-xl max-w-2xl mx-auto">
        ...
        {rooms.map((room, index) => (
          <div
            ...
            className={`flex items-center justify-center p-6 bg-white rounded-lg shadow-lg cursor-pointer hover:bg-yellow-50/20 hover:border-yellow-500 transition-transform duration-200 ease-in-out ${
              currentRoom === room.name ? 'border-4 border-blue-500/75 transform scale-105' : 'border border-gray-200'
            }`}
          >
            <img
              src={room.image}
      ...
      {currentRoom && (
        <div>
          <h3 className="text-2xl font-semibold text-gray-800 mb-4">Room: {currentRoom}</h3>
